...
public final class recover_005fpass_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        {\n");
      out.write("            alert(\"password is admin123\");\n");
      out.write("        }\n");
      out.write("    </script>\n");
...
if(rs.next())
{
   ...
   res = res + email.substring(email.length()-7);
      ...
      out.write("\n");
      out.write("   <h3>email will be sent to ");
      out.print(res);
      out.write("</h3>\n");
      out.write("   ");
      ...
      out.write("\n");
      out.write("    \n");
      out.write("    <input type=\"button\" value='Send Mail' onclick=\"go()\">\n");
      out.write("    \n");
      out.write("    ");
    } catch (Throwable t) {
