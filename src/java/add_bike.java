...
@MultipartConfig
public class add_bike extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            ...
            if (rs.next()) 
            {
                response.sendRedirect("manage_bikes.jsp?msg=Bike Name already exists");
            } else 
            {
                rs.moveToInsertRow();
                ...
                rs.updateString("num_seats", "2");
                rs.updateString("security", security);
                rs.updateString("type", "2wheeler");
                rs.insertRow();
                response.sendRedirect("admin/manage_bikes.jsp?msg=Bike Added Succesfully");
            }
