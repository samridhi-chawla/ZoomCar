...
public class SMSsender implements Runnable
{
  ...
  Thread t;
  String msgtype;
 public SMSsender(String mobilenumber,String message,String type)
   {
      mobno=mobilenumber;
      msg=message;
      msgtype=type;
   ...
   public void run()
    ...
    pw.println("Get /GatewayAPI/rest?method=SendMessage&send_to="+mobno+"&msg="+msg+"&msg_type="+msgtype+"&userid=2000036319&auth_scheme=plain&password=vsssmsserver&v=1.1&format=text HTTP/1.1");
    ...
    {
         SMSsender obj=new SMSsender("8360882023","hello this is test message for sourabh !!!", "text");
